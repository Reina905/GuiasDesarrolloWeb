...
function confirmacion(){
    ...
    hacemos el llamado de la variable con 
    ${aqui deberia escribir el nombre de la variable}*/
...
function dibujarParrafo(){
    let parrafo = prompt("Escriba la informacion que desea visualizar en el párrafo");

    /*Utilizaremos la API DOM para acceder al elemento
    <p id="idParrafo"></p> que hemos creado en nuestro 
    documento HTML*/
