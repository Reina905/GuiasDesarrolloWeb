...
function generarEstudiantes(){
    ...
    while (contador <= totalEstudiantes){
        ...
        //Asignando los valores de arreglo
        arrayEstudiante[contador - 1] = new Array(estudiante, parseFloat(calificacion).toFixed(2));
        contador++;
    }

    //Recorriendo el arreglo con for...of verificaremos cual es el promedio de las calificaciones
    //y cual de los estudiantes posee la calificación mas alta
