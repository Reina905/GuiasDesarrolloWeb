//Otra forma de acceder a un elemento HTML es utilizado el getElementById del DOM
...
const validarNumero = function(e){
    //creamos una expresion regular que válida que sean numeros
    let validar = /^[0-9]{1}$/;
    let tecla = e.key;

    /* 
    .text válida que la expresión regular coincida con el valor ingresado
