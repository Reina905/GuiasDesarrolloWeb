...
//Accedamos a cada botón por medio de la API DOM
...
function calcularTabla(){
    ...
    //verfiquemos que el dato colocado sea un numero entero positivo
    if (inputTabla > 0){
        let tabla = `<h2>Tabla de multiplicar del ${inputTabla}</h2>`;
        //Utilizaremos do while para generar la tabla de multiplicar que el usuario ha indicado
        do {
